              ...
              <div class="row m-0 h-100 align-items-center">
                <div class="col-12">
                  <div class="d-flex gap-2 justify-content-between">
                    <div class="">
                      <div class="mb-3">
                        <h4 class="mb-1">Welcome Back, <?= $active_user['first_name'] ?>!</h4>
                    ...
                    <div class="">
                      <img class="wd-50 ht-50 rounded-circle" src="https://ui-avatars.com/api/?name=<?= $active_user['name'] ?>" alt="">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body">
              ...
              <div id="simple-list" class="row">
                <div id="example1" class="list-group col">
                  <?php for ($i=0; $i < 6; $i++): ?>
                  <div class="list-group-item d-flex g-3">
                      <i class="link-icon handle me-2 p-1" data-feather="chevrons-right"></i>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="taskCheckbox<?= $i ?>">
                      <label class="form-check-label" for="taskCheckbox<?= $i ?>">
                        Task title <?= $i ?>
                      </label>
                    </div>
                  </div>
